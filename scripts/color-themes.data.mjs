...
export function validateColorThemesCss(css) {
  ...
  if (issues.length)
    throw new Error(`color-themes.css validation failed:\n${issues.join('\n')}`)
}
...
export function buildColorThemesCss() {
  ...
  return `/* Generated by scripts/generate-color-theme-css.mjs — do not edit by hand */\n\n${[
    ...primaryBlocks,
    ...neutralBlocks,
    ...radiusBlocks,
