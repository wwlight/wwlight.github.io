...
<CardGrid stagger>
  ...
  <Card title='算法'>
    - [The Algorithms](https://the-algorithms.com/zh_Hans) <Badge text="推荐" variant='success' />
...
<CardGrid stagger>
  <Card title='AI'>
    ...
    - [AI SDK](https://sdk.vercel.ai/) <Badge text="vercel" />
  ...
  <Card title='产品'>
    ...
    - [ShipAny](https://shipany.ai/zh) - 快速构建 AI 创业项目
  </Card>
  <Card title='在线'>
    - [bolt.new](https://bolt.new/)
    - [v0.dev](https://v0.dev/) <Badge text="vercel" />
  </Card>
  <Card title='工具插件'>
