...
$ git branch -D <branch>                                # 强制删除本地分支 # [注意] 未合并改动将丢失
...
$ git push origin --delete <branch>                     # 删除远程分支 # [注意] 影响所有协作者
$ git push origin :<branch>                             # 删除远程分支（旧写法） # [注意] 影响所有协作者
...
$ git checkout -f main                                  # 强制切换 # [注意] 未提交改动将丢失
