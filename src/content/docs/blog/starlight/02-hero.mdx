...
- **书签 / 管理端**：不在 Starlight 布局内，不走 `Hero`；首页 `actions` 链到 `/bookmarks/`、`/blog/`。
...
**相关：** [01 · 站点导航](/blog/starlight/01-site-navigation/) · 随机主题见 `src/theme/components/HeroRandomThemeButton.tsx`
