...
| --- | --- |
| [导读](/blog/) | 架构总览 |
| [01](/blog/01-architecture/) | 模块边界与数据流 |
| [02](/blog/02-site-navigation/) | 双层导航 |
| [03](/blog/03-data-layer/) | Astro DB 与 seed |
| [04](/blog/04-public-page/) | 公开页 islands |
| [05](/blog/05-admin-auth/) | 鉴权门控 |
| [06](/blog/06-admin-ui/) | 管理 UI |
| [07](/blog/07-dev-api-and-deploy/) | API 与部署 |
...
至此，书签导航与管理端系列完结。代码仓库：[github.com/wwlight/wwlight.github.io](https://github.com/wwlight/wwlight.github.io)。
