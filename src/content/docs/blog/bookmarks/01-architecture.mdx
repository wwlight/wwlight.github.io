...
- src/bookmarks/
  ...
  - shared/
    ...
    - components/ — BookmarkFavicon、PageHeader、StatsCards
    - styles/ — bookmarks-theme-shared.css
  - nav/
...
- src/pages/
  - bookmarks/nav.astro — 导航薄入口 → `/bookmarks/nav/`
  - bookmarks/admin.astro — 管理端薄入口 → `/bookmarks/admin/`
- db/
...
文档站与书签模块 **共享 Header 主题**，但书签页 **不走 Starlight 布局**——独立 Astro 页面挂载 React 根组件，导航页可全宽布局。
