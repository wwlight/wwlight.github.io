...
- 与 `@/theme` 全站 Primary / Neutral / Radius、明暗同步
...
| 样式 | Tailwind CSS 4 + shadcn + `@/theme` token | `bookmarks-theme-shared.css`、`.bookmark-card` |
...
局部文档见 [`src/bookmarks/README.md`](https://github.com/wwlight/wwlight.github.io/blob/main/src/bookmarks/README.md)。主题定制见 [主题系列](/blog/theme/)；Astro / Starlight 见 [Astro 使用](/blog/astro/)。
