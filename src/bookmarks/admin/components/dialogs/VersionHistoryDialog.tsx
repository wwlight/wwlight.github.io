...
} from "@/bookmarks/admin/components/dialogs/VersionActionConfirmDialog";
...
} from "@/bookmarks/admin/lib/admin-api";
import type { BookmarkSectionData, VersionEntry } from "@/bookmarks/shared/types";
